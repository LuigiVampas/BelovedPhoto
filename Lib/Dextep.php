...
class Dextep{
	...
	*/
	protected $cacheEnabled = false;			// true = caching enabled, false = disabled
	protected $cachePath = 'Templates/Cache/';		// path to cache folder
	protected $templatePath = 'Templates/'; // path to templates folder
	protected $templateExt = '.tpl';		// templates extension
	...
	*/
	public function getTemplate($name, $recache = false){
